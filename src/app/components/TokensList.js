...
import { FaExternalLinkAlt, FaTwitter, FaGlobe, FaSearch, FaFilter, FaSync, FaShare, FaCheckCircle } from 'react-icons/fa';
import { HiSpeakerphone } from "react-icons/hi";
import { MdOutlineRefresh, MdVerified } from "react-icons/md";
import Link from 'next/link';

// Target token CA from environment variable
...
const TokensList = () => {
  ...
  // Check if token is the target token
  ...
  // Verified Badge Component (Twitter OG style with scalloped/cloudy edges)
  const VerifiedBadge = () => (
    <div 
    ...
    >
      <svg 
        ...
        aria-label="Verified"
      >
        {/* Blue scalloped/cloudy background shape */}
        <path 
          fill="#1D9BF0" 
        ...
        <path 
          fill="#FFFFFF" 
          d="M9.64 15.67l-3.47-3.47 1.41-1.41 2.06 2.06 5.18-5.18 1.41 1.41-6.59 6.59z"
        />
      </svg>
    </div>
  );
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-shrink-0 relative">
                        ...
                        {/* Blue Verified Checkmark for Target Token */}
                        {isTargetToken(token) && <VerifiedBadge />}
                      </div>
